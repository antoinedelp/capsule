...
var React = __webpack_require__(1);
var TilesList = __webpack_require__(28);
...
var Home = function (_React$Component) {
  ...
  _createClass(Home, [{
    key: 'render',
    value: function render() {
      return React.createElement(TilesList, null);
    }
  }]);
...
var React = __webpack_require__(1);
var Tiles = __webpack_require__(29);

var comparaison = [];

var TilesList = function (_React$Component) {
  _inherits(TilesList, _React$Component);

  function TilesList() {
    _classCallCheck(this, TilesList);

    var _this = _possibleConstructorReturn(this, (TilesList.__proto__ || Object.getPrototypeOf(TilesList)).call(this));
  ...
  _createClass(TilesList, [{
    key: 'handleClick',
    value: function handleClick(animalName) {
      /*this.setState({
        selected: true
      })*/
    ...
    value: function render() {
      ...
      for (var i = 0; i < cards.length; i++) {
        if (this.state.selected == true) {
          tiles.push(React.createElement(Tiles, { handleClickTilesList: this.handleClick, animal: cards[i].name, image: cards[i].image, id: i }));
        } else {
          tiles.push(React.createElement(Tiles, { handleClickTilesList: this.handleClick, animal: cards[i].name, id: i, image: questionMark }));
        }
      }
...
var Tiles = function (_React$Component) {
  ...
  function Tiles() {
    ...
    var _this = _possibleConstructorReturn(this, (Tiles.__proto__ || Object.getPrototypeOf(Tiles)).call(this));
  ...
  _createClass(Tiles, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        "li",
        { className: "recto", "data-target": this.props.id, onClick: this.handleClick },
        " ",
